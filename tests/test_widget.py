...
@pytest.mark.parametrize('account_id, masks', [('Maestro 1596837868705199', 'Maestro 1596 83** **** 5199'),
...
@pytest.mark.parametrize('str_date, masks', [('2024-03-11T02:26:18.671407', '11.03.2024'),
